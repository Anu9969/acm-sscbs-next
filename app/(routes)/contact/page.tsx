      ...
      <section className=" relative w-full h-[60vh] flex justify-center gap-20 flex-col  px-28 pr-44 items-center">
        <div className=" flex justify-between  items-center">
          ...
          <div className="main z-10">
            <div className="up ">
              <button className="card1 flex justify-center items-center  shadow-white hover:shadow-sm">
                <svg
              ...
              <button className="card2  flex justify-center items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 48 48"
                  width="30px"
            ...
            <div className="down ">
              <button className="card3 flex justify-center items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 30 30"
                  width="30px"
              ...
              <button className="card4 flex justify-center items-center ">
                <svg
                  height="30px"
                  width="30px"
                  viewBox="0 0 48 48"
        ...
        <div className=" w-full px-2 grid grid-cols-3 gap-5 h-28">
          <div className=" w-full gap-2 h-24  flex justify-center items-center">
            <div className="relative flex-1  flex h-full w-full hover:-translate-y-2 duration-100 justify-center flex-col overflow-hidden rounded-lg border bg-background px-4 md:shadow-xl">
              <p className="z-10  text-left text-sm font-bold text-white">
