    ...
    return (   
        <main className=' min-h-screen w-full pt-16'>
            <section className=' w-full min-h-screen flex flex-col items-center py-16 border-b border-gray-500 '>
                ...
                <iframe className=' aspect-video md:w-2/3 rounded-md z-10 w-full px-5' src="https://www.youtube.com/embed/QIW2lEZgSUM" title="ACM Orientation" frameBorder="0" allow=" autoplay; clipboard-write; encrypted-media; gyroscope;  web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
            </section>
            <section className=' w-full min-h-screen flex flex-col items-center py-16 '>
                ...
                <h2 className=' text-xl text-zinc-200/50 mb-24'>Welcome, Batch &apos;26 & &apos;27 – your journey to excellence starts now. Let&apos;s make history together at SSCBS!</h2>
